 ...
 *
 * A form component that allows users to search for weather information by location.
 * Displays a search input field and submit button with loading state indication.
 *
 * @component
 */
